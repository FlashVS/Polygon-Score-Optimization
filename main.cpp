...
signed main(){
    ...
    //change input file name and output file name accordingly

    freopen("input/input09.txt", "r", stdin); // input
    freopen("output/output09.txt", "w", stdout); // output

    achieved = 0;

    _input();   

    pair<int, set<pair<pair<double, double>, pair<double, double>>>> ans;
    ...
    cout << ans.first << endl;
    cout << ans.second.size() << ", " << ans.second.size() << endl;
